...
urlpatterns = [
    ...
    path('montar-kit/contato', MontarKitContato.as_view(), name='contato_montar_kit'),
    path('montar-kit/solicitacao-enviada', MontarKitSolicitacaoEnviada.as_view(), name='solicitacao_kit_enviada'),
