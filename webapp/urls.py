...
urlpatterns = [
    ...
    path('montar-kit', MontarKitFormulario.as_view(), name='montar_kit'),
    path('montar-kit/filas', MontarKitFilas.as_view(), name='montar_kit_filas'),
    path('montar-kit/confirmar-itens', MontarKitConfirmar.as_view(), name='montar_kit_confirmar'),
    path('montar-kit/contato', MontarKitContato.as_view(), name='montar_kit_contato'),
    path('montar-kit/solicitacao-enviada', MontarKitSolicitacaoEnviada.as_view(), name='montar_kit_solicitacao_enviada'),
